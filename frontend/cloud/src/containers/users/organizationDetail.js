            ...
            confirmationDialog(
                ...
                () => {
                    ...
                    if (_.values(this.props.organizationUserRoles).length === 1) {
                        ...
                        this.props.history.push(`/users/${this.props.userID}/organizations`)
                    } else {
...
const makeMapStateToProps = () => {
    const getOrganizationUserUserRoles = makeGetOrganizationUserUserRoles()
...
export default withRouter(connect(makeMapStateToProps, mapDispatchToProps)(OrganizationDetail))
