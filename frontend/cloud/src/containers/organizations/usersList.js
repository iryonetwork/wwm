...
class UsersList extends React.Component {
    ...
    determineState(props) {
        ...
        if (!loading) {
            this.setState({
                organizationUsers: _.map((props.organizationUserIDs ? props.organizationUserIDs : []), userID => {return props.users[userID]}),
    ...
    newUser = () => e => {
        if (this.state.organizationUsers) {
            let organizationUsers = [...this.state.organizationUsers, { id: "", edit: true, canSave: false, domainType: "organization", domainID: this.props.organizationID, userID: "", roleID: "" }]
...
const makeMapStateToProps = () => {
    ...
    const mapStateToProps = (state, ownProps) => {
        ...
        return {
            ...
            userRoles: state.userRoles.domainUserRoles ? ((state.userRoles.domainUserRoles["organization"] && state.userRoles.domainUserRoles["organization"][organizationID]) ? state.userRoles.domainUserRoles["organization"][organizationID] : undefined) : undefined,
