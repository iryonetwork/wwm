...
InConsultation = connect(
    state => ({
        ...
        canSeeLaboratoryTests: false, //((state.validations.userRights || {})[RESOURCE_LABORATORY_TEST] || {})[READ],
        canAddLaboratoryTests: false, //((state.validations.userRights || {})[RESOURCE_LABORATORY_TEST] || {})[WRITE],
