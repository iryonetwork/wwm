...
export const composePatientData = formData => dispatch => {
    return dispatch(buildContextForPatientData(formData)).then(context => {
        return Promise.all([buildPersonData(context, formData), buildInfoData(context, formData)]).then(([person, info]) => ({ person, info }))
    })
}
    ...
    return Promise.all([dispatch(loadCode("countries"))]).then(([countries]) => {
        ...
        ;(formData.chronicDiseases || []).forEach((el, i) => {
            data = compose(data, el, [
                // Name
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0015]:${i}/items[at0018]`, "disease"),
                // Date
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0015]:${i}/items[at0017]`, "date"),
                // Comment
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0015]:${i}/items[at0016]`, "comment")
            ])
        })
        ...
        ;(formData.immunizations || []).forEach((el, i) => {
            data = Object.assign(data, [
                // Name
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0014]:${i}/items[at0019]`, "immunization"),
                // Date
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0014]:${i}/items[at0021]`, "date")
            ])
        })
        ...
        ;(formData.allergies || []).forEach((el, i) => {
            data = Object.assign(data, [
                // Name
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0009]:${i}/items[at0010]`, "allergy"),
                // Critical (BOOL)
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at00009]:${i}/items[at0012]`, "critical"),
                // Comment
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0009]:${i}/items[at0013]`, "comment")
            ])
        })
        ...
        ;(formData.injuries || []).forEach((el, i) => {
            data = Object.assign(data, [
                // Name
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0022]:${i}/items[at0023]`, "injury"),
                // Date
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0022]:${i}/items[at0024]`, "date"),
                // Comment
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0022]:${i}/items[at0025]`, "medication")
            ])
        })
        ...
        ;(formData.surgeries || []).forEach((el, i) => {
            data = Object.assign(data, [
                // Name
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0026]:${i}/items[at0028]`, "injury"),
                // Date
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0026]:${i}/items[at0029]`, "date"),
                // Comment
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0026]:${i}/items[at0030]`, "medication")
            ])
        })
        ...
        ;(formData.medications || []).forEach((el, i) => {
            data = Object.assign(data, [
                // Name
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0031]:${i}/items[at0032]`, "medication"),
                // Comment
                assignValue(`/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0031]:${i}/items[at0034]`, "comment")
            ])
        })
        ...
        data = compose(data, formData, [
            // Number of kids
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0047]", "numberOfKids"),
            // Nationality
            assignCode(countries, "/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0048]", "nationality"),
            // Country of origin
            assignCode(countries, "/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0049]", "countryOfOrigin"),
            // Education
            assignValue(
                // @TODO
            ...
            // Occupation
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0058]", "profession"),
            // Date of leaving home country
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0059]", "dateOfLeaving"),
            // Date of arriving to camp
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0061]", "dateOfArrival"),
            // Transit countries
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0062]/items[at0060]", "transitCountries")
        ])
        ...
        data = compose(data, formData, [
            // Are you smoking
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0036]/items[at0039]", "habits_smoking"),
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0036]/items[at0038]", "habits_smoking_comment"),
            // Taking drugs
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0051]/items[at0040]", "habits_drugs"),
            // Resources for basic hygiene
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0052]/items[at0041]", "conditions_basic_hygiene"),
            // Access to clean water
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0053]/items[at0042]", "conditions_clean_water"),
            // Sufficient food supply
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0054]/items[at0043]", "conditions_food_supply"),
            // Good appetite
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0055]/items[at0044]", "conditions_good_appetite"),
            // Accommodations have heating
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0056]/items[at0045]", "conditions_heating"),
            // Accommodations have electricity
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0036]/items[at0057]/items[at0046]", "conditions_electricity")
        ])
        ...
        data = compose(data, formData, [
            ...
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0065]", "vaccinationUpToDate"),
            // Has Immunization documents (BOOLEAN)
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0066]", "vaccinationCertificates"),
            // Tested for tuberculosis (BOOLEAN)
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0067]", "tuberculosisTested"),
            // Were tuberculosis tests positive (BOOLEAN)
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0068]", "tuberculosisTestResult"),
            // Any additional tests done (BOOLEAN)
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0069]", "tuberculosisAdditionalInvestigationDetails"),
            // Investigation details
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0070]", "tuberculosisAdditionalInvestigation"),
            // Any reaction to vaccines (BOOLEAN)
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0071]", "vaccinationReaction"),
            // Details of vaccine reactions
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0064]/items[at0072]", "vaccinationReactionDetails")
        ])
        ...
        data = compose(data, formData, [
            ...
            // Premature
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0074]/items[at0076]", "prematurity"),
            // Weeks at birth
            assignInteger("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0074]/items[at0077]", "weeksAtBirth"),
            // Weight at birth
            assignQuantity("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0074]/items[at0078]", "weightAtBirth", "gm"),
            // Height at birth
            assignQuantity("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0074]/items[at0079]", "heightAtBirth", "cm"),
            // Breastfeeding
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0087]/items[at0081]", "breastfeeding"),
            // Breastfeeding for how long
            assignInteger("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0087]/items[at0082]", "breastfeedingDuration"),
            ...
            assignInteger("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0084]", "babyWetDiapers"),
            ...
            assignInteger("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0086]", "babyBowelMovementsComment"),
            // Satisfied with sleep
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0088]/items[at0089]", "babySleep"),
            // Comment about the sleep
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0088]/items[at0090]", "babySleepComment"),
            // Do you take / give vit. D
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0091]", "babyVitaminD"),
            // Baby sleeps on her back
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0092]", "babySleepOnBack"),
            // Does anyone smoke
            assignBoolean("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0093]", "babyAnyoneSmokes"),
            // Number of smokers
            assignInteger("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0094]", "babyNumberOfSmokers"),
            // How does child get around
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0095]", "babyGetsAround"),
            // How does child communicate
            assignValue("/content[openEHR-EHR-ITEM_TREE.patient_info.v0]/items[at0073]/items[at0080]/items[at0096]", "babyCommunicates")
        ])
...
const assignValue = (ehrPath, formPath, staticValue) => (data, formData) => {
