...
const operationSeconds metrics.ID = "operationSeconds"
const operationAdd string = "add"
const operationUpdate string = "update"
const operationGet string = "get"
const operationDelete string = "delete"
...
func GetPrometheusMetricsCollection() map[metrics.ID]prometheus.Collector {
	...
	h := prometheus.NewHistogramVec(prometheus.HistogramOpts{
		...
		Help:      "Time taken to execute storage operation",
...
// New Bolt creates returns new bolt based key-value storage
func NewBolt(ctx context.Context, filepath string, logger zerolog.Logger, metricsCollection map[metrics.ID]prometheus.Collector) (Storage, error) {
