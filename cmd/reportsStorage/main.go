...
//go:generate sh -c "mkdir -p ../../gen/reportsStorage && swagger generate server -A reportsStorage -t ../../gen/reportsStorage -f ../../docs/api/reportsStorage.yml --exclude-main --principal string"
...
import (
	...
	"github.com/iryonetwork/wwm/gen/reportsStorage/restapi"
	...
	storage "github.com/iryonetwork/wwm/service/reportsStorage"
...
func main() {
	...
	api := operations.NewReportsStorageAPI(swaggerSpec)
	...
	api.ReportListHandler = storageHandlers.ReportList()
	api.ReportGetHandler = storageHandlers.ReportGet()
	api.ReportGetVersionHandler = storageHandlers.ReportGetVersion()
	api.ReportListVersionsHandler = storageHandlers.ReportListVersions()
	api.ReportNewHandler = storageHandlers.ReportNew()
	api.ReportUpdateHandler = storageHandlers.ReportUpdate()
	api.ReportDeleteHandler = storageHandlers.ReportDelete()
